...
public class DstbServiceImpl2 implements IDstbService2 {
    ...
    private String[] CATALOG = {"WEB2390", "WEB2389", "WEB2388", "WEB2382", "WEB2385", "WEB2384", "WEB2387"};
                    ...
                    if ("1".equals(map2.get("result"))) {
                        ...
                        for (int i = 0; i <= pageBegin; i++) {
                            ...
                            if (CollectionUtils.isEmpty(ac43TempLists)) {
                                ...
                                //更新日志 zw_java_log
                                insertLog(begin, end, start, "zw_ac43_390_temp" + v1, aaa027);
                                break;
                            } else {
                                pageBegin += 2000;
                                pageEnd += 2000;
                        ...
                        insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "ac43_390temp表", "all");
                    }
                }
            }
        } else {
            insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "zw_ac43_390", "all");
        }
    }
                    ...
                    if ("1".equals(map2.get("result"))) {
                        ...
                        for (int i = 0; i <= pageBegin; i++) {
                            ...
                            if (CollectionUtils.isEmpty(ac43TempLists)) {
                                ...
                                long end = System.currentTimeMillis();
                                //更新日志 zw_java_log
                                insertLog(begin, end, start, "zw_ac43_temp" + v1, aaa027);
                                break;
                            } else {
                                pageBegin += 2000;
                                pageEnd += 2000;
                        ...
                        insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "ac43temp表", "all");
                    }
                }
            }
        } else {
            insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "zw_ac43", "all");
        }
//        //获取上次跟新的时间
...
//        }
    ...
    public void zwKc26IncrementData() {
        //获取开始时间
        String beginTime = "2020-10-29 17:01:01";//configMapper.getDbTime();
        Map<String, Object> map = new HashMap<>();
        map.put("result", "1");
        ...
        if ("1".equals(map.get("result"))) {
            ...
            insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "zw_kc26", "all");
        }
    }
                    ...
                    if ("1".equals(map2.get("result"))) {
                        ...
                        for (int i = 0; i <= pageBegin; i++) {
                            ...
                            if (CollectionUtils.isEmpty(zwKc01Lists)) {
                                ...
                                long end = System.currentTimeMillis();
                                //更新日志 zw_java_log
                                insertLog(begin, end, start, "zw_kc01_temp" + v1, aaa027);
                                break;
                            } else {
                                pageBegin += 2000;
                                pageEnd += 2000;
                        ...
                        insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "kc01_temp表", "all");
                    }
                }
            }
        } else {
            insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "zw_kc01", "all");
        }
    }
                    ...
                    if ("1".equals(map2.get("result"))) {
                        ...
                        for (int i = 0; i <= pageBegin; i++) {
                            ...
                            if (CollectionUtils.isEmpty(zwKc99Lists)) {
                                ...
                                long end = System.currentTimeMillis();
                                //更新日志 zw_java_log
                                insertLog(begin, end, start, "zw_kc99_temp" + v1, aaa027);
                                break;
                            } else {
                                pageBegin += 2000;
                                pageEnd += 2000;
                        ...
                        insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "kc99_temp表", "all");
                    }
                }
            }
        } else {
            insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "zw_kc99", "all");
        }
    }
                ...
                if ("1".equals(map2.get("result"))) {
                    ...
                    for (int i = 0; i <= pageBegin; i++) {
                        ...
                        if (CollectionUtils.isEmpty(zwAc01Lists)) {
                            ...
                            long end = System.currentTimeMillis();
                            //更新日志 zw_java_log
                            insertLog(begin, end, start, "zw_ac01", aaa027);
                            break;
                        } else {
                            pageBegin += 2000;
                            pageEnd += 2000;
                    ...
                    insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "ac01_temp表", "all");
                }
            }
        } else {
            insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "zw_ac01", "all");
        }
    }
    ...
    public void zwKslwIncrementData() {
        ...
        if ("1".equals(map.get("result"))) {
            for (String aaa027 : AAA027_ARRAYS) {
                ...
                for (int i = 0; i <= pageBegin; i++) {
                    ...
                    if (CollectionUtils.isEmpty(zwKslwLists)) {
                        ...
                        long end = System.currentTimeMillis();
                        //更新日志 zw_java_log
                        insertLog(begin, end, start, "zw_kslw", aaa027);
                        break;
                    } else {
                        pageBegin += 2000;
                        pageEnd += 2000;
            ...
            insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "zw_kslw", "all");
        }
        //线程延迟10秒等上面的数据处理完
//        try {
//            Thread.sleep(10000);
                ...
                if ("1".equals(map2.get("result"))) {
                    ...
                    for (int i = 0; i <= pageBegin; i++) {
                        ...
                        if (CollectionUtils.isEmpty(zwKa08Lists)) {
                            //结束时间
                            long end = System.currentTimeMillis();
                            insertLog(begin, end, start, "zw_ka08", aaa027);
                            break;
                        } else {
                            pageBegin += 2000;
                            pageEnd += 2000;
                    ...
                    insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "ka08_temp表", "all");
                }
            }
        } else {
            insertLog(0, 0, "出错,详情查看ZW_ERROR_LOG表", "zw_ka08", "all");
        }
